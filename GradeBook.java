...
public class GradeBook
{
    ...
    private int[] [] grade; //numberOfStudents rows and numberOfQuizzes
                            //columns
    ...
    private void fillStudentAverage()
    {
        ...
        {//Process one studentNumber:
            ...
            //sum contains the sum of the quiz socres for student number
            //studentNumber
    ...
    public void display()
    {
        ...
        for (int quizNumber = 1; quizNumber <= numberOfQuizzes; quizNumber++)
            System.out.print("Quiz " + quizNumber + " Ave = " +
                    quizAverage[quizNumber - 1] + " ");
        System.out.println();
    }
    ...
    {
        int retrieve = grade[studentNumber] [quizNumber];
        return retrieve;
    }
