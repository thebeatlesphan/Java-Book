...
invariant: All elements are at the beginning of the array in locations 0,1,2 and
so forth up to a highest index with no gaps.
*/
public class PartiallyFilledArray
{
    ...
    /**
     Sets the maximum number of allowable elements to 19.
     */
