...
public class GolfScores
{
    ...
    /**
     Reads values into the array a. Returns the number of values placed in
     the array a.
     */
    ...
    /**
    Precondition: numberUsed <= .alength.
    ...
    numberUsed elements of the array a differ form their average.
    */
    ...
    /**
     pre - numberUsed <= argumentArray.length;
     the first numberUsed indexed variables of argumentArray have values.
     Returns an array of length numberUsed whose ith element is
     argumentArray[i] - adjustment.
     */
    public static double[] differenceArray(double[] argumentArray,
                    int numberUsed, double adjustment)
    {
